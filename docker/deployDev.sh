...
#docker run --detach --hostname $UCNAME --publish 8080:8080 --mount source=external-volume,target=/home/pharmaledger/acdc-workspace/apihub-root/external-volume --name $UCNAME --restart always pharmaledger/$UCNAME
